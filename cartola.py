def dados_cartola(ano):
    try:
        ...
        with open(f'/home/livia/Downloads/dados_cartola_fc/cartola_fc_{ano}.txt', 'r', encoding='utf-8') as arquivo:
            dados = arquivo.read()
        return dados
    except FileNotFoundError:#caso o arquivo não seja encontrado, será retornado um erro
        return f"Arquivo de dados para o ano {ano} não encontrado."
    
ano_desejado = input("Digite o ano para acessar os dados (2021 ou 2022): ") #o usuário vai selecionar qual ano quer ver os dados
...
#o esquema montado conforme na tabela apresentada
